...
<iframe src="{{ '/assets/html/cu_map1.html' | relative_url }}" width="100%" height="650px" style="border: none;"></iframe>
<div class="caption">
    Interactive map created using OpenStreetMap data, showing [describe briefly what the map depicts].
</div>
